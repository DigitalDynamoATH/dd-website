...
// Console message
console.log('%c👋 Γεια σας!', 'font-size: 20px; font-weight: bold; color: #1e3a8a;');
console.log('%cΙωάννης Νεκτάριος Κουνουπάς - Digital Dynamo', 'font-size: 14px; color: #6b7280;');
